...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision :chef_client do |chef|
    chef.chef_server_url = "https://api.opscode.com/organizations/protowouter"
    chef.validation_key_path = ".chef/protowouter-validator.pem"
    chef.validation_client_name = "protowouter-validator"
